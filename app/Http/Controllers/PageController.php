...
class PageController extends Controller
{
    public function getHome(Request $req)
    {
        ...
        $meta_title="FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    public function getLogin(Request $req)
    {
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShop chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShop, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Đăng nhập - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    public function getRegister(Request $req){
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShop chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShop, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Đăng ký - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    public function getCheckout(Request $req){
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShop chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShop, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Đặt hàng - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    public function postCheckout(Request $req){
        ...
        {
            $mesage->from('quocloc160398@gmail.com','Flower Shop');
        ...
        return redirect()->back()->with('thongbao','Bạn đã đặt hàng thành công. Vui lòng kiểm tra Email!');
    }
    ...
    {
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShopDaLat chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShopDaLat, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Giỏ hàng - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    public function getSearch(Request $req)
    {
        ...
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShopDaLat chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShopDaLat, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Tìm kiếm - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    public function getProfileUser(Request $req)
    {
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShopDaLat chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShopDaLat, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Hồ sơ - Người dùng - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    {
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShopDaLat chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="ma giam gia,hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShopDaLat, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Mã giảm giá - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    public function getPurchaseHistory(Request $req)
    {
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShopDaLat chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShopDaLat, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Lịch sử mua hàng - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    {
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShopDaLat chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="lien he qua website FlowerShopDaLat,hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShopDaLat, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Liên hệ - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
    ...
    {
        $meta_desc="Shop hoa tươi uy tín và giá cạnh tranh. Đặt hoa online, giao miễn phí 2 giờ. FlowerShopDaLat chuyên hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_keywords="Dien dan website FlowerShopDaLat,bai viet hay tren FlowerShopDaLat,hoa dep cho su kien, hoa đẹp cho sự kiện FlowerShopDaLat, shop hoa, hoa tươi, giao hoa, hoa chúc mừng, hoa khai trương, hoa chia buồn, lan hồ điệp";
        $meta_title="Diễn đàn - FlowerShopDaLat - Đồng hành cùng khách hàng. Điện hoa chất lượng hàng đầu Việt Nam";
