...
<head>
    ...
    <title>FlowerShopDaLat - Admin</title>
    <base href="{{asset(' ')}}"/>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="text-align:center;line-height:35">
                                <img src="admin_asset/assets/dest/img/logohhd.png"/>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Chào mừng bạn đến với trang quản trị của FlowershopDaLat!</h1>
                                    </div>
                                    ...
                                    <form class="user" role="form" action="admin/login" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success btn-user btn-block">Đăng nhập</button>
                                    </form>
                                    <hr>
                                </div>
                            </div>
