                ...
                <form action="admin/shop/edit/{{$shop_type->id}}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="name" value="{{$shop_type->name}}" placeholder="Hãy nhập tên cửa hàng" />
                                </div>
                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <input class="form-control" name="description" value="{{$shop_type->description}}" placeholder="Hãy nhập mô tả cho cửa hàng" />
                                </div>
                </div>
                        ...
                        <div class="leave-comment">
                            ...
                            <div class="input-group">
                                ...
                                <div id="preview_thumbnail" class="preview-img" style="padding-top:30px;text-align:center">
                                    <img src="{{$shop_type->image}}" style="height:9rem;">
                                <div>
                                </div>
