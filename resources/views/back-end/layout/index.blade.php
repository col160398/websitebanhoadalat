...
<head>
    ...
    <title>Quản lý Website FlowerShopDaLat</title>
    <base href="{{asset(' ')}}"/>
...
<body id="page-top">
    ...
    <script>
    var options = {
        filebrowserImageBrowseUrl: '/flowershopdalat/public/laravel-filemanager?type=Images',
        filebrowserImageUploadUrl: '/flowershopdalat/public/laravel-filemanager/upload?type=Images&_token=',
        filebrowserBrowseUrl: '/flowershopdalat/public/laravel-filemanager?type=Files',
        filebrowserUploadUrl: '/flowershopdalat/public/laravel-filemanager/upload?type=Files&_token='
    };
    </script>
    <script>
