            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                    <div class="filter-widget">
                        ...
                        @foreach($shop as $l)
                            <li><a href="{{route('shop',$l->id)}}">@if($l->id==$url)<p style="color:#6db340">{{$l->name}} ({{count($l->product)}})</p>@else <p style="color:#000">{{$l->name}} ({{count($l->product)}})</p>@endif</a></li>
                        @endforeach
                        </ul>
                    </div>
                    <div class="filter-widget">
                        ...
                        <div class="fw-brand-check">
                            ...
                            <div class="bc-item">
                                <label for="{{$l->name}}">
                                <a href="{{route('shop',$l->id)}}">{{$l->name}}</a>
                                    <input type="checkbox" id="{{$l->name}}" @foreach($sp_theoloai as $sp) @if($sp->id_type==$l->id) checked @endif @endforeach>
                    ...
                    <div class="filter-widget">
                        ...
                        @foreach($color as $cl)
                                    <div class="cs-item">
                                        <a onclick="window.location.href='shop/{{$url}}?feature={!!$cl->id!!}'">
